...
export const UI_COPY = {
  ...
  stats: {
    ...
    openDuneThp: 'THP for Good dashboard (Dune)',
    duneGnosisTitle: 'Gnosis app overview',
    duneThpTitle: 'THP for Good on-chain metrics',
    duneAggregateTitle: 'Dune aggregate (cached)',
    duneAggregateNote: 'On-chain totals from Dune Analytics — not from app SQLite.',
    duneCrcTreasury: 'CRC to treasury (Dune)',
    duneCrcExperts: 'CRC to experts (Dune)',
    dunePaidTxCount: 'Paid txs (Dune)',
