  ...
  return (
    <div
      className={motionClass(
        'fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background/95 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] backdrop-blur-sm md:hidden',
        'motion-sticky-bar-in',
        reducedMotion,
      )}
    >
